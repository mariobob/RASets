# Grand Theft Auto: San Andreas - Cheaters Paradise (Subset)
...
## Subset concept
This subset celebrates GTA: San Andreas's legendary cheat code system. Instead of punishing cheaters, we reward creative, chaotic, and skillful use of cheats. Every achievement requires activating specific cheats and accomplishing challenges that would not be possible in vanilla gameplay.

**Philosophy:** Cheats are part of what made San Andreas iconic. This subset turns cheat codes into achievement challenges.

## Subset plan key
| Class | Symbol | Description |
| --- | --- | --- |
| Achievement | 🟥 | Not coded |
| Achievement | 🟨 | Coded but untested |
| Achievement | 🟩 | Coded and tested |
| Achievement | 🟪 | Not coded, unsure if keeping |
| Achievement | 🟧 | Coded, unsure if keeping |
| Achievement | 📈 | Has progress tracking |
| Achievement | ⏱️ | Time-based challenge |
| Achievement | 🔢 | Count-based tally |
| Achievement | ⚠️ | Missable |
| Badge | 🔴 | Not created |
| Badge | 🟡 | Draft created |
| Badge | 🟢 | Final created |

## General caveats
* **This is a SUBSET** - All achievements require cheat usage. The main set prohibits cheats.
* Achievements track across save/load - cumulative tallies persist (kills, explosions, etc.)
* Survival challenges (marked ⏱️) require continuous conditions - dying or disabling cheats resets progress
* Some cheats **cannot be turned off** once activated (Pedestrian Riot, Peds Attack)
* Memory addresses are based on the PS2 NTSC version
* Rich Presence displays cheat usage count, wanted level, and money
...
| --- | --- | --- | --- |
| | **Aggressive Drivers** | | |
| 🟥🔴 | ALLDRIVERSARECRIMINALS | *(Achievements to be added)* | - |
| | **Aggressive Traffic** | | |
...
| | **Junk Cars Traffic** | | |
| 🟥🔴 | BGKGTJH | *(Achievements to be added)* | - |
| | **Black Cars** | | |
| 🟨🔴 | SOLONGASITSBLACK | Activate Black Cars cheat | 1 |
| | **Funhouse Theme** | | |
| 🟨🔴📈🔢 | Clown Fiesta | Cause 10 explosions with Funhouse Theme active | 2 |
| | **Moon Car Gravity** | | |
| 🟨🔴 | BUBBLECARS | Activate Moon Gravity and send a car flying | 1 |
| 🟨🔴📈🔢 | It's Raining Cars | Activate Moon Gravity 5 times in one session | 1 |
| | **Pedestrian Riot** | | |
...
| | **Rural Traffic** | | |
| 🟥🔴 | EVERYONEISPOOR | *(Achievements to be added)* | - |
| | **Rural Theme** | | |
...
| 🟨🔴 | DONTTRYANDSTOPME | Activate Traffic Lights Stay Green | 1 |
| | **Triad Theme** | | |
...
| | **Cloudy Weather** | | |
| 🟥🔴 | DULLDULLDAY | *(Achievements to be added)* | - |
| | **Fast Motion** | | |
...
| | **Foggy Weather** | | |
| 🟥🔴 | CANTSEEWHEREIMGOING | *(Achievements to be added)* | - |
| | **Overcast Weather** | | |
...
| 🟨🔴📈🔢 | Serial Cheater | Use cheats 50 times in a single playthrough | 2 |
| 🟨🔴📈🔢 | Professional Cheater | Use cheats 100 times in a single playthrough | 3 |
...
## Known issues / TODOs
Some achievements have incomplete trigger logic due to missing memory addresses:
...
| Address | Description |
| --- | --- |
| `0x88d70b` - `0x88d75b` | Cheat activation flags (40+ individual cheats) |
| `0x8022f4` | Times cheated counter |
| `0x7096b4` | Player money |
| `0x19eb73c` | Wanted stars displayed |
| `0x8022b4` | People wasted by player |
| `0x7095d0` | Player pointer (HP, Armor, Position, Vehicle) |
| `0x66b7ac` - `0x66b7b8` | Game clock |
| `0x6b2654` | In active mission flag |
| `0x6ffab0` | Pause flag |

Full memory documentation: https://retroachievements.org/codenotes.php?g=2772

## Files
| File | Description |
| --- | --- |
| [`cheaters-paradise.rascript`](cheaters-paradise.rascript) | RAScript source code |
| [`2772-User.txt`](2772-User.txt) | Compiled achievement triggers |
| [`2772-Rich.txt`](2772-Rich.txt) | Rich Presence script |
| [`resources/code-notes.md`](resources/code-notes.md) | Local memory address documentation |

## Rich presence
Dynamic display showing:
- Current activity (on foot / driving / jetpack)
- Vehicle name when driving
- Cheat usage count
- Wanted level stars
- Current money

## Building
Requires [RATools](https://github.com/Jamiras/RATools):
```bash
# Compile the script
./rascript -i cheaters-paradise.rascript -o .

# Output files:
# - 2772-User.txt (achievement triggers)
# - 2772-Rich.txt (rich presence)
```

## Contributing
1. Memory research: Help find missing addresses listed in TODOs
2. Testing: Verify achievements trigger correctly in-game
3. Balance: Suggest point adjustments or difficulty tweaks
4. Ideas: Propose new creative cheat-based achievements

---

_"I'll have two number 9s, a number 9 large, a number 6 with extra dip, a number 7, two number 45s, one with cheese, and a large soda." — Big Smoke_

![order](https://media1.tenor.com/m/kn8hVABg480AAAAd/gta-big-smoke-order-big-smoke.gif)
